...
def parse_args():
    ...
    parser.add_argument('--frame_count', type=int, default=96, help='number of frames to be coded')
    parser.add_argument('--results_dir', type=str, default='mpeg-results', help='directory to store results (in csv format)')
