...
def parse_args():
    ...
    parser.add_argument('--decay_rate', type=float, default=5e-5, help='decay rate [default: 1e-4]')
    ...
    parser.add_argument('--dataset_dir', default='/home/old/gaolinyao/dataset_npy', type=str)
